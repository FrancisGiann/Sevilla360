...
$assert(str_contains($nav, 'if ($is_admin_user):') && str_contains($nav, 'else:') && str_contains($nav, 'page=overview') && str_contains($nav, 'page=calendar') && str_contains($nav, 'page=bookings') && str_contains($nav, 'page=walkin') && str_contains($nav, 'page=maintenance') && !str_contains($nav, 'page=sales') && str_contains($nav, 'page=reviews') && str_contains($nav, 'page=usermanagement') && str_contains($nav, 'page=auditlog') && str_contains($nav, 'page=cms') && str_contains($nav, 'page=settings'), 'Sales is removed while the remaining role-specific routes stay available');
...
$assert($monthlyBlock !== '' && str_contains($monthlyBlock, 'Monthly Sales') && str_contains($monthlyBlock, 'id="stat-monthly-sales"') && str_contains($monthlyBlock, '<div class="stat-card">') && !str_contains($monthlyBlock, 'page=sales'), 'Monthly Sales remains an admin-only static metric without a dead destination');
