...
$assert(str_contains($nav, 'if ($is_admin_user):') && str_contains($nav, 'else:') && str_contains($nav, 'page=overview') && str_contains($nav, 'page=calendar') && str_contains($nav, 'page=bookings') && str_contains($nav, 'page=walkin') && str_contains($nav, 'page=maintenance') && str_contains($nav, 'page=sales') && str_contains($nav, 'page=reviews') && str_contains($nav, 'page=usermanagement') && str_contains($nav, 'page=auditlog') && str_contains($nav, 'page=cms') && str_contains($nav, 'page=settings'), 'admin retains 11 links, staff retains their six authorized links, and route values remain unchanged');
...
$assert($monthlyBlock !== '' && str_contains($monthlyBlock, 'Monthly Sales') && str_contains($monthlyBlock, 'id="stat-monthly-sales"') && !str_contains($monthlyBlock, 'Restricted'), 'Monthly Sales is admin-only markup, not a restricted placeholder for staff');
