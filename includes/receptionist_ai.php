...
function receptionist_ai_normalize_output(array $payload, mysqli $conn, array $baseSlots, array $faqs, string $fallbackLanguage = 'en', ?array $venueCatalog = null): array
{
    ...
    $safeReplies = [
        'en' => [
            'ask' => 'I can help narrow the venue, stay, dates, and guest details. Choose a suggestion or tell me what you have in mind.',
            'recommend' => 'I’ll use those details to prepare the matching media-ready options for you.',
            'venue' => 'I’ll open the selected venue in the showroom so you can review its guided details.',
            'availability' => 'I’ll check the selected dates through the current availability flow. No hold is created here.',
            'contact' => 'I do not want to guess about that resort detail. Please contact reception and the team will confirm it for you.',
            'unsupported' => 'I can help with venues, availability guidance, bookings, resort policies, and the Support FAQs. For anything else, please contact reception.',
        ],
        'fil' => [
            'ask' => 'Matutulungan kitang pumili ng venue, stay, petsa, at bilang ng bisita. Pumili ng mungkahi o sabihin ang kailangan mo.',
            'recommend' => 'Gagamitin ko ang mga detalye para ipakita ang angkop na media-ready options.',
            'venue' => 'Bubuksan ko ang napiling venue sa showroom para makita mo ang guided details nito.',
            'availability' => 'Susuriin ko ang napiling petsa sa availability flow. Walang hold na ginagawa rito.',
            'contact' => 'Ayokong manghula tungkol sa resort detail na iyan. Makipag-ugnayan sa reception para makumpirma ito.',
            'unsupported' => 'Makakatulong ako sa venues, availability guidance, bookings, resort policies, at Support FAQs. Para sa iba, makipag-ugnayan sa reception.',
        ],
        'taglish' => [
            'ask' => 'I can help you choose a venue, stay, dates, and guest count. Pumili ng suggestion or sabihin ang kailangan mo.',
            'recommend' => 'Gagamitin ko ang details mo para ipakita ang matching media-ready options.',
            'venue' => 'I’ll open the selected venue sa showroom para ma-review mo ang guided details.',
            'availability' => 'I’ll check the selected dates sa current availability flow. Walang hold na gagawin dito.',
            'contact' => 'Ayokong manghula tungkol sa resort detail na iyan. Contact reception para makumpirma ito.',
